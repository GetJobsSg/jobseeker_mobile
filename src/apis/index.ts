...
export const clockIn = (id: number, code: string) =>
  put(`/mobile/job/attendance/in/${id}`, { code }).then((res) => res.data);

export const clockOut = (id: number, code: string) =>
  put(`/mobile/job/attendance/out/${id}`, { code }).then((res) => res.data);
