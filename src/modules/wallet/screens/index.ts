...
export { default as BankAccountDetailScreen } from './bank-account-details.screen';
export { default as AddEditBankAccountScreen } from './add-edit-bank-account.screen';
